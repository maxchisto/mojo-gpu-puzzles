...
fn tiled_elementwise_add[
    ...
    fn process_tiles[
        ...
        @parameter
        for i in range(0, tile_size, simd_width):
            a_simd = a_tile.aligned_load[simd_width](Index(i))
            b_simd = b_tile.aligned_load[simd_width](Index(i))
            res = a_simd + b_simd
            output_tile.store[simd_width](Index(i), res)
